...
Prints "Classes:" followed by mlb.classes\_ array showing unique emotion labels
Prints blank line
...
Prints "Classes:" followed by array of emotion class names from mlb.classes\_
Prints blank line
...
Main processing logic in main.py/solution.py with if **name** == "**main**": main() entry point
