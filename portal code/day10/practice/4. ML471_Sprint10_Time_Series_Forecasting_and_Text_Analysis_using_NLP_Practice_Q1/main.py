...
def main():
    ...
    if "binary_sentiment" in train_df.columns:
        train_df["ft_label_binary"] = "__label__" + train_df["binary_sentiment"].astype(
            str
        )
    ...
    if "sentiment" in train_df.columns:
        train_df["ft_label_multiclass"] = "__label__" + train_df["sentiment"].astype(
            str
        )
        ...
        test_df["ft_format_multiclass"] = (
            test_df["ft_label_multiclass"] + " " + test_df["clean_text"]
        )
    ...
    if "emotion_labels" in train_df.columns:
        ...
        train_df["ft_format_multi"] = (
            train_df["ft_label_multi"] + " " + train_df["clean_text"]
        )
